			...
			<ul class="nav nav-tabs row" id="myTab" role="tablist">
				<li class="nav-item col-md-3 col-sm-12 col-12 plr-clear">
					<a class="nav-link pt-5 pb-5 active" id="general-tab" data-toggle="tab" href="#general" role="tab" aria-controls="general" aria-selected="true">
						<img src="<?php echo e(asset('main/images/icons/faq-general.png')); ?>" class="img-fluid m-auto d-block" alt="" width="100">
				...
				<li class="nav-item col-md-3 col-sm-12 col-12 plr-clear">
					<a class="nav-link pt-5 pb-5" id="booking-tab" data-toggle="tab" href="#booking" role="tab" aria-controls="booking" aria-selected="false">
						<img src="<?php echo e(asset('main/images/icons/faq-booking.png')); ?>" class="img-fluid m-auto d-block" alt="" width="100">
				...
				<li class="nav-item col-md-3 col-sm-12 col-12 plr-clear">
					<a class="nav-link pt-5 pb-5" id="service-tab" data-toggle="tab" href="#service" role="tab" aria-controls="service" aria-selected="false">
						<img src="<?php echo e(asset('main/images/icons/faq-service.png')); ?>" class="img-fluid m-auto d-block" alt="" width="100">
				...
				<li class="nav-item col-md-3 col-sm-12 col-12 plr-clear">
					<a class="nav-link pt-5 pb-5" id="giftCard-tab" data-toggle="tab" href="#giftCard" role="tab" aria-controls="giftCard" aria-selected="false">
						<img src="<?php echo e(asset('main/images/icons/faq-giftcard.png')); ?>" class="img-fluid m-auto d-block" alt="" width="100">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/manojvelyalan/Sites/airport-assist-laravel/resources/views/main/home/faq.blade.php ENDPATH**/ ?>