                ...
                <tr>
                    <td>
                        <div style="margin-left: 80px;margin-top: 20px;margin-bottom: 20px;">
                            Dear <?php echo e(ucwords($request->titleName.". ".$request->firstName." ".$request->lastName)); ?>,
                        </div>
                        <div style='margin-left: 80px;margin-top: 20px;'>
                                Thank you for your enquiry. We are totally committed to providing the best airport assistance in all major Airports across the world.
...
<?php /**PATH /Users/manojvelyalan/Sites/airport-assist-laravel/resources/views/emails/main/user-request-success.blade.php ENDPATH**/ ?>