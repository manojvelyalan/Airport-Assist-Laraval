                          ...
                          <form class="pb-1 " id="step-2-form">
                              <div class="alert alert-danger d-none" id="mainError"></div>
                                          ...
                                          <select name="mainService" id="mainService" class="form-control">
                                            <option value="">Select Service Type</option>
                                              <?php $__currentLoopData = $serviceTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serviceType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($serviceType->id); ?>" ><?php echo e(ucwords($serviceType->title)); ?></option>
                                  ...
                                  <div class="btn-group float-right" role="group">
                                    <a href="/step-1?r=<?php echo e($request->id); ?>" class="btn btn-MUA-next float-right brand-bg-red ">Previous</a>
