                ...
                <tr>
                    <td>
                        <div style="margin-left: 80px;margin-top: 20px;margin-bottom: 20px;">
                            Dear <?php echo e($data['fullName']); ?>,
                        </div>
                        <div style='margin-left: 80px;margin-top: 20px;padding-right: 20px;text-align: justify;'>
                            <p>
                                We are pleased to process your request for <?php echo e($data['serviceType']); ?> service at <?php echo e($data['airport']); ?> on <?php echo e($data['serviceDate']); ?>.
                            </p>
                            <p>
...
<?php /**PATH /Users/manojvelyalan/Sites/airport-assist-laravel/resources/views/emails/payment.blade.php ENDPATH**/ ?>