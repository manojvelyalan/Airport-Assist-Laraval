...
<!-- End Facebook Pixel Code -->
    <head>
       ...
       <link rel="stylesheet" href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
        ...
        <link rel="stylesheet" href="{{asset('main/css/intlTelInput.css')}}">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav">
                             <li class="nav-item hvr-overline-from-center">
                                <a class="nav-link text-uppercase" href="{{route('bookservice')}}">Book Airport Service</a>
                            </li>
                            <li class="nav-item hvr-overline-from-center">
...
<script src=" {{asset('main/js/intlTelInput.js')}}" type="text/javascript" ></script>
